			...
			<form action="{{route('register-user')}}" method="POST"> @csrf
				<div class="col-md-8 center no-padding">
					...
					<div class="col-md-6 form-group">
						...
						<input type="text" name="fname" class="form-control input-lg" placeholder="First Name" value="" id="fname"> </div>
					<div class="col-md-6 form-group">
						<label class="">Last Name</label>
						<input type="text" name="lname" class="form-control input-lg" placeholder="Last Name" value="" id="lname"> </div>
					<div class="col-md-6 form-group">
						<label class="">Email</label>
						<input type="email" name="email" class="form-control input-lg" placeholder="Email" value="" id="email"> </div>
					<div class="col-md-6 form-group">
						<label class="">Organization / Company</label>
						<input type="text" name="company" class="form-control input-lg" placeholder="Organization" value="" id="company"> </div>
					<div class="col-md-6 form-group">
						<label class="">Password</label>
						<input type="password" name="password" class="form-control input-lg" placeholder="Password" value="" id="password"> </div>
					<div class="col-md-12 form-group ">
						<label class="">Address</label>
						<input type="text" name="address1" class="form-control input-lg" placeholder="Street" value="" id="address1"> </div>
					<div class="col-md-6 form-group">
						<input type="text" name="address2" class="form-control input-lg" placeholder="Apartment, Unit, etc" value="" id="address2"> </div>
					<div class="row"></div>
					<div class="col-md-6 form-group">
					...
					<div class="col-md-6 form-group">
						<label>City</label>
						<input type="text" name="city" class="form-control input-lg" placeholder="City" value="" id="city"> </div>
					<div class="col-md-6 form-group">
						<label class="">Postcode / Zip</label>
						<input type="text" name="postcode" class="form-control input-lg" placeholder="Postcode / Zip" value="" id="postcode"> </div>
					<div class="col-md-6 form-group">
						<label class="">Phone</label>
						<input type="text" name="phone" class="form-control input-lg" placeholder="Phone" value="" id="phone"> </div>
					<div class="col-md-12 form-group">
