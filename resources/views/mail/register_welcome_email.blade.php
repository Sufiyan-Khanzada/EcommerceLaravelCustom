                                ...
                                <tr style="border-collapse:collapse">
                                  <td class="es-m-txt-c es-m-p0" align="center" style="padding:0;Margin:0">
                                    <h2 style="Margin:0;line-height:29px;mso-line-height-rule:exactly;font-family:arial, helvetica neue, helvetica, sans-serif;font-size:24px;font-style:normal;font-weight:normal;color:#FFFFFF">
                                      <strong>Registration Successful at Firequick</strong>
                                    </h2>
                                  </td>
                                </tr>
                                <tr style="border-collapse:collapse">
                                  <td class="es-m-txt-c es-m-p0" align="center" style="padding:10px;Margin:0">
                                    <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:arial, helvetica neue, helvetica, sans-serif;line-height:24px;color:#FFFFFF">
                                      <strong>Welcome to Firequick Products, Inc</strong>
                                    </p>
                                  </td>
                                </tr>
                              </table>
                        ...
                        <table cellspacing="0" cellpadding="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                          <tr style="border-collapse:collapse">
                            <td align="left" style="padding:0;Margin:0;width:560px">
                              <table cellspacing="0" cellpadding="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                <tr style="border-collapse:collapse">
                                  <td class="es-m-p0" align="left" style="padding:0;Margin:0;padding-top:15px"><h3 style="Margin:0;line-height:30px;mso-line-height-rule:exactly;font-family:arial, helvetica neue, helvetica, sans-serif;font-size:20px;font-style:normal;font-weight:normal;color:#333333">Thanks for creating an account on Firequick Products, Inc. Your <strong>username </strong>is <u>
                                        <strong>{{ $email }}</strong>
                                      </u>.  Please note that your account will need to be fully approved before any orders can be placed. Firequick Products Inc. will email you with full details on how to approve your account. You can access your account area to view your orders and change your password here:&nbsp; </h3>
                                  </td>
                                </tr>
                                <tr style="border-collapse:collapse">
                        ...
                        <table cellspacing="0" cellpadding="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                          <tr style="border-collapse:collapse">
                            <td class="es-infoblock" align="center" style="padding:0;Margin:0;line-height:0px;font-size:0px;color:#CCCCCC">
                              <a target="_blank" href="" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, helvetica neue, helvetica, sans-serif;font-size:12px;text-decoration:underline;color:#CCCCCC">
