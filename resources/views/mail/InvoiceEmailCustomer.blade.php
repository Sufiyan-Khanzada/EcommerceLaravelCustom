...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" style="width:100%;font-family:arial, helvetica neue, helvetica, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0">
  <head>
    ...
    <title>New Order at Firequick</title>
    <style type="text/css">
                                ...
                                <tr style="border-collapse:collapse">
                                  <td class="es-m-txt-c es-m-p0" align="center" style="padding:0;Margin:0">
                                    <h2 style="Margin:0;line-height:29px;mso-line-height-rule:exactly;font-family:arial, helvetica neue, helvetica, sans-serif;font-size:24px;font-style:normal;font-weight:normal;color:#FFFFFF">
                                      <strong>New Order at Firequick</strong>
                                    </h2>
                                  </td>
                                </tr>
                                <tr style="border-collapse:collapse">
                                  <td class="es-m-txt-c es-m-p0" align="center" style="padding:10px;Margin:0">
                                    <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:arial, helvetica neue, helvetica, sans-serif;line-height:24px;color:#FFFFFF">Dear Firequick Customer <strong>'.{{$customers->fname}}{{$customers->lname}}.'</strong>
                                    </p>
                                  </td>
                                </tr>
                              </table>
                                ...
                                <tr style="border-collapse:collapse">
                                  <td class="es-m-p0" align="left" style="padding:0;Margin:0;padding-top:15px">
                                    <h3 style="Margin:0;line-height:30px;font-family:arial,helvetica neue,helvetica,sans-serif;font-size:20px;font-style:normal;font-weight:normal;color:#333333">Thank you for placing your order with us. For your convenience, the tracking information will be emailed to you via FedEx Ground. If you have any other further questions, please do not hesitate to call <strong>
                                        <a href="tel:760-377-5766" style="font-family:arial,helvetica neue,helvetica,sans-serif;font-size:20px;text-decoration:underline;color:#ff4000;line-height:30px" target="_blank">760-377-5766</a>
                                      </strong>. Thank you for your business – we appreciate it very much and look forward to serving you again in the future. Have a great day! </h3>
                                    ...
                                    <h3 style="Margin:0;line-height:30px;font-family:arial,helvetica neue,helvetica,sans-serif;font-size:20px;font-style:normal;font-weight:normal;color:#333333">
                                      <strong>Firequick Customer Services.</strong>
                                    </h3>
                                  </td>
                                </tr>
                              </table>
